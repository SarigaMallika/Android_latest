...
public class Home_page_positive_scenarios extends Generic_functions{
	...
	public static void verifyTheWelcomePage() throws Exception {
		try {
	...
	public static void home_positive_tc_004() throws InterruptedException, Exception {
		try {
	...
	public static void refer_a_friend_page() throws Exception {
		try {
	...
	public static void home_positive_tc_005() throws Exception {
		try {
	...
	public static void navigated_to_the_refer_a_friend_page() throws Exception {
