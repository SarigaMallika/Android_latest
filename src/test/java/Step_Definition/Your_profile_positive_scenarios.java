...
public class Your_profile_positive_scenarios extends Generic_functions{
	...
	public static void enter_login_data() throws Exception {
		try {
			app_login(9,0);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void yourprofile_positive_tc_002() throws Exception {
		try {
	...
	public static void add_otp_password() throws Exception {
		try {
	...
	public static void yourprofile_positive_tc_003() throws Exception {
		try {
			stale_click("prof_edit_icon");
			page_wait(2000);
	...
	public static void yourprofile_positive_tc_004() throws Exception  {
		try {
			page_wait(1000);
	...
	public static void yourprofile_positive_tc_005() throws Exception {
		try {
	...
	public static void yourprofile_positive_tc_006() throws Exception {
		try {
	...
	public static void yourprofile_positive_tc_007() throws Exception {
		try {
			page_wait(1000);
			stale_click("prof_phone_number");
	...
	public static void yourprofile_positive_tc_008() throws Exception {
		try {
			page_wait(3000);
	...
	public static void yourprofile_positive_tc_009() throws Exception {
		try {
			page_wait(1000);
			value = driver.findElement(By.xpath(OR_reader("prof_address"))).isDisplayed();
			Assert.assertEquals(true,value);
	...
	public static void yourprofile_positive_tc_010() throws Exception {
		try {
			page_back();
			page_wait(1000);
	...
	public static void yourprofile_positive_tc_011() throws Exception {
		try {
			stale_click("prof_plan_coverage");
			page_wait(1000);
	...
	public static void yourprofile_positive_tc_012() throws Exception {
		try {
			page_wait(1000);
			page_back();
	...
	public static void yourprofile_positive_tc_013() throws Exception {
		try {
			stale_click("prof_edit_password");
			stale_click("prof_old_password");
			driver.findElement(By.xpath(OR_reader("prof_old_password"))).sendKeys(td_reader("your_prof_old_password"));
